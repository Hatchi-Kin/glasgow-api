...
#     """Create the track_visualization table in PostgreSQL."""
#     try:
#         with get_postgres_connection() as conn:
#             with conn.cursor() as cursor:
#                 cursor.execute("""
#                     CREATE TABLE IF NOT EXISTS track_visualization (
...
#                     );
#                     CREATE INDEX IF NOT EXISTS idx_track_visualization_cluster ON track_visualization(cluster);
#                 """)
#                 conn.commit()
#         return {"status": "success", "message": "track_visualization table created or already exists."}
#     except Exception as e:
#         logger.error(f"Failed to create track_visualization table: {str(e)}")
#         raise HTTPException(status_code=500, detail=f"Failed to create table: {str(e)}")


# def load_visualization_data_from_minio(
#     bucket_name: str = "megaset",
#     object_name: str = "music_visualization_data.json"
# ):
#     """
...
#                     cursor,
#                     """
#                     INSERT INTO track_visualization (id, x, y, z, cluster, cluster_color)
#                     VALUES %s
